...
/* 
 CanvasJS Chart - v3.8.10 GA - https://canvasjs.com/ 
 Copyright 2024 fenopix
...
a.stockChart.dispatchEvent("rangeChanging",a.stockChart._rangeEventParameter,a.stockChart));a.render();a.syncCharts&&(a.stockChart.rangeUpdatedBy=!a.stockChart.navigator.slider||n(a.stockChart.navigator.slider.options.minimum)&&n(a.stockChart.navigator.slider.options.maximum)?!a.stockChart.rangeSelector.enabled||!a.stockChart.rangeSelector.inputFields.enabled||n(a.stockChart.rangeSelector.inputFields.options.startValue)&&n(a.stockChart.rangeSelector.inputFields.options.endValue)?null:"inputFields":
...
2,d+e/2),c.stroke(),c.moveTo(a+e/2,d-e/2),c.lineTo(a-e/2,d+e/2),c.stroke())}},drawMarkers:function(a){for(var d=0;d<a.length;d++){var c=a[d];W.drawMarker(c.x,c.y,c.ctx,c.type,c.size,c.color,c.borderColor,c.borderThickness)}}};return m}();t.version="v3.8.10 GA";window.CanvasJS&&(t&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=t)})();
